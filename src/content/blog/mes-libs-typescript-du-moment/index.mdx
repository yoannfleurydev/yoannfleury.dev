...
Un des autres moyens d'écrire du bon TS, c'est d'éviter d'écrire du code spécifique à TypeScript comme, par exemple, les `enum` ou les `namespace` qui sont une feature en plus qui devra être traduit en JavaScript, mais qui ne fait pas du 1 pour 1.
