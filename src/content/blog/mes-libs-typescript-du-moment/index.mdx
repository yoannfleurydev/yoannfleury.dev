...
Ce que j’entends par là, c’est que le meilleur moyen de profiter de TypeScript, c’est de profiter de son inférence de types, parce qu'on ne va pas se mentir, personne n'aime maintenir des types, mais également en évitant d'écrire du code spécifique à TypeScript comme, par exemple, les `enum` ou les `namespace`.
...
J’espère que cet article t’as plu ! Dans tous les cas, n'hésite pas à me le faire savoir sur X ou autres réseaux disponible dans le bas de page.
